      ...
      <main className="flex flex-1 flex-col items-center justify-center pt-32 pb-16 px-4">
        <div className="bg-white/90 rounded-xl shadow-lg p-8 w-full max-w-md flex flex-col items-center">
          ...
          <form className="w-full flex flex-col gap-4">
            <input type="text" placeholder="Full Name" className="px-4 py-2 rounded border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#3b82f6]" />
          ...
          <p className="mt-4 text-sm text-gray-700">Already have an account? <Link href="/login" className="text-[#3b82f6] font-semibold hover:underline">Login</Link></p>
        </div>
      </main>
    </div>
  );
