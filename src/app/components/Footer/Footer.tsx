...
export default function Footer() {
  return (
    <footer className="w-full bg-[var(--navbar)] px-4 py-4 text-[var(--foreground)] pt-16 pb-8 px-4 mt-12 border-t-4 border-[#3b82f6]/40">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div>
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-2xl font-extrabold tracking-wide text-[#fbbf24]">QUIZ SYSTEM</span>
          </div>
          <p className="mb-4">A modern, secure, and interactive quiz platform for schools, teachers, and students. Empowering digital learning and assessment for the next generation.</p>
